	...
	function valida_actualizar_MaterialesClinicoss()
	{
		var Go =false;
		Go=$("#validar_actualizar_MaterialesClinicos").validationEngine('validate');
		...
		if(Go==true)
		 ...
		 $.ajax({
				   ...
				   url:"../php/Actualizar_MaterialesClinicos.php",
				   data: parametros,
	...
	function llegadaDatos(datos)
	{
		...
		$('#validar_actualizar_MaterialesClinicos')[0].reset();
	}
