	...
	function EliminarMateriaISC()
	{
		var Go =false;
		Go=$("#validar_eliminar_Medicamento").validationEngine('validate');
		...
		if(Go==true)
		 ...
		 $.ajax({
				   ...
				   url:"../php/eliminar_medicamento.php",
				   data: parametros,
	...
	function llegadaDatos(datos)
	{
		...
		$('#validar_eliminar_Medicamento')[0].reset();
	}
