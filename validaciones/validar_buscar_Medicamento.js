	...
	function validar_buscar_Medicamentos()
	{
		var Go =false;
		Go=$("#validar_buscar_Medicamento").validationEngine('validate');
		...
		if(Go==true)
		 ...
		 $.ajax({
				   ...
				   url:"../php/buscar_medicamento.php",
				   data: parametros,
	...
	function llegadaDatos(datos)
	{
		...
		$('#validar_buscar_Medicamento')[0].reset();
	}
