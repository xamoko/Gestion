...
<nav>
  ...
  <body>
	...
	<section id="registro"class="main">
		<form name="validar_buscar_Medicamento" id="validar_buscar_Medicamento" method="post" onblur="limpia()"  >

        <h3>Introduzca la Clave del Medicamento que Desea Buscar </h3>
		 ...
		 <table class="tb1">
            ...
            <tr>
                ...
                <td><input type="text" name="clave" id="clave" placeholder="Clave" class="validate[required]"></td>
                    ...
                    <tr><td></td>
				<td class="t3"><input type="button" value="Buscar" onClick="validar_buscar_Medicamentos()"></td>
				    </tr>   
        </table>
