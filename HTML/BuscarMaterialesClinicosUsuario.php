...
<html>
        <head>
			...
			<script src="../validaciones/validar_buscar_MaterialesClinicos.js" type="text/javascript"></script>
...
<nav>
  ...
  <body>
	...
	<section id="registro"class="main">
		<form name="validar_buscar_MaterialesClinicos" id="validar_buscar_MaterialesClinicos" method="post" onblur="limpia()"  >

        <h3>Introduzca la Clave del Material que desea Buscar </h3>
		 ...
		 <table class="tb1">
            ...
            <tr>
                ...
                <td><input type="text" name="clave" id="clave" placeholder="Clave" class="validate[required]"></td>
                    ...
                    <tr><td></td>
				<td class="t3"><input type="button" value="Buscar" onClick="valida_buscar_MaterialesClinicoss()"></td>
				    </tr>   
        </table>
