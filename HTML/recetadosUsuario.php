...
<nav>
    <section id="navcont">
        <ul>
            <a href="../html/MenuRecetadosUsuario.php"><li>Inicio</li></a>
            <a href="#"><li></li></a>
            <a href="h#"><li></li></a>
		...
		<form name="AddRecetados" id="AddRecetados" method="post" onblur="limpia()"  >
		 ...
		 <table class="tb1">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="Clave_Medicamento(2)" id="Clave_Medicamento(2)" placeholder="Clave del Medicamento(2)" class="validate[required]"></td>
                            </tr>
                            <tr>
                                <td class="t3">Clave del Medicamento(3)</td>
                                <td><input type="text" name="Clave_Medicamento(3)" id="Clave_Medicamento(3)" placeholder="Clave del Medicamento(3)" class="validate[required]"></td>
                            </tr>
                            <tr>
                                <td class="t3">Clave del Medicamento(4)</td>
                                <td><input type="text" name="Clave_Medicamento(4)" id="Clave_Medicamento(4)" placeholder="Clave del Medicamento(4)" class="validate[required]"></td>
                            </tr>
                            <tr>
