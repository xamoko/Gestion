...
require ('conexion.php');
	...
	$clave				        = $_POST['clave'];
		...
		echo
			  '
              <form name="validar_Eliminar_MaterialesClinicos2" id="validar_Eliminar_MaterialesClinicos2" method="post" onblur="limpia()"  >
              <table>
              <tr>
                                <tr>
                            ...
                            <tr><td></td>
                                <td class="t3"><input type="button" value="Eliminar" onClick="valida_Eliminar_MaterialesClinicos2()"></td>
