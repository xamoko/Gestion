...
require ('conexion.php');
	...
	$clave				        = $_POST['clave'];
		...
		echo
			  '
              <form name="validar_actualizar_MaterialesClinicos2" id="validar_actualizar_MaterialesClinicos2" method="post" onblur="limpia()"  >
              <table>
              <tr>
                                <tr>
                            ...
                            <tr><td></td>
                                <td class="t3"><input type="button" value="Actualizar" onClick="valida_actualizar_MaterialesClinicos2()"></td>
